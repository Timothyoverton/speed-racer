...
| `multiplayer.spec.js` | Two browser contexts against the **deployed** relay: host + deep-link join, synced countdown, live opponent car on the other screen, gap HUD, head-to-head result, rematch. |
